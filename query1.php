...
<html lang="en">
    ...
    <body>
			...
			<div class="center">
				<div class="banner" style="background-image: url('images/query1-banner.jpg'); background-size: 100vw 100vh; background-attachment: fixed;">
				<div class="text-overlay">
					<h1 style="font-size: 4.8vw; color: white;">QUERY 1</h1>
					<h2 style="text-align: center; margin-top: -1.5vw; font-size: 1.75vw;">All Songs sorted by Title and Artist(s) Z-A</h2>
