...
<html lang="en">
    ...
    <body>
			...
			<div class="center">
				<div class="banner" style="background-image: url('images/country-banner.jpg'); background-size: 100vw 100vh; background-attachment: fixed;">
				<div class="text-overlay">
					<h1 style="font-size: 4.8vw; color: white;">COUNTRY</h1>
					<h2 style="text-align: center; margin-top: -1.5vw; font-size: 1.75vw;">All Country And Acoustic Songs</h2>
			...
			<div class="content" style="text-align: left;"> 
                        ...
                        <heading1>
                        	...
                        	<?php
								...
								//creates a variable to store the sql query that displayed all country song info sorted by song ID
