...
<html lang="en">
	...
	<head>
		...
		<meta name="Description" content="TuneIn Rock Genre"/>
    ...
    <body>
			...
			<div class="center">
				<div class="banner" style="background-image: url('images/rock-banner.jpg'); background-size: 100vw 100vh; background-attachment: fixed;">
				<div class="text-overlay">
					<h1 style="font-size: 4.8vw; color: white;">ROCK</h1>
					<h2 style="text-align: center; margin-top: -1.5vw; font-size: 1.75vw;">All The Best Rock Music In One</h2>
				<?php
								...
								WHERE g.Genre = 'Alternative'
								OR g.Genre = 'Rock'
								OR g.Genre = 'Alternative Metal'
								OR g.Genre = 'Alternative Rock'
								OR g.Genre = 'Avante-Garde'
								OR g.Genre = 'Celtic Rock'
								OR g.Genre = 'Folk Rock'
								OR g.Genre = 'Gothic Rock' 
								OR g.Genre = 'Indie Rock' 
								OR g.Genre = 'Nu-Metal'
								OR g.Genre = 'Post-Grunge'
								OR g.Genre = 'Post-Rock'
								OR g.Genre = 'Progressive Rock'
								OR g.Genre = 'Psychadelic'");
			...
			<div class="content" style="text-align: left;">  
                        ...
                        <heading1>
                        	...
                        	<?php
								...
								//creates a variable to store the sql query that displayed all rock song info sorted by song ID
